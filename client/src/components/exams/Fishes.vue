...
export default {
  ...
  data() {
    ...
    //   mixins: [mixins],
      ...
      facilities:this.$store.getters.fetchGetFishes,//
      pageMode:'readOnly',
      editMode:false,
      pageEdit:false,
      tooltipDelay:700,
      fetchList:this.$store.getters.fetchGetFishes,//need to be changed!!
      list:[],
      listName:'fishes',//need to be changed!!
      item: '',
      itemName: 'fish',
      modalDirty:false,
      modal2:false
  ...
  created () {
        ...
        this.list = this.$store.getters.fetchGetFishes;
  },
    watch:{
